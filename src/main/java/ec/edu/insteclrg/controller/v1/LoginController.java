...
public class LoginController {
	...
	public ResponseEntity<Object> login(@RequestBody LoginDTO loginDTO) {
		...
		if (user != null && user.getPassword().equals(loginDTO.getPassword())) {
			return new ResponseEntity<>(new ApiResponseDTO<>(true, "Inicio de sesión con exitoso"), HttpStatus.OK);
		} else {
			return new ResponseEntity<>(new ApiResponseDTO<>(false, "Datos inválidos"), HttpStatus.UNAUTHORIZED);
		}
	}
}
